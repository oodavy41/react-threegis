    ...
    componentWillMount() {
        loadModules(
            ...
            this.TScene = new TScene(
                ...
                externalRenderers,
                SpatialReference,
                [this.props.position.originX, this.props.position.originY],
                this.props.position.size
            );
            this.TScene.setMousePos(this.props.mousePos, this.props.presentPos);
            this.TScene.updateFPS = this.props.updateFPS;
            externalRenderers.add(this.props.view, this.TScene);
        });
    }

    makeGraphic(Point, Mesh, Graphic, sx, sy, sz, dx, dy, z, color) {
